    ...
    <div class="content">
        ...
        <form method="GET" class='form-create'>
            <table>
                ...
                <tfoot>
                    <tr class="btn-td">
                        <td colspan="2" class="btn-td"><input type="submit" value="Editar empleado" name="enviar" class="btn"></td>
                    </tr>
                </tfoot>
                <tbody>
                    <tr class='tr-label'>
                        <th id='codigoEmpleado'><label for="codEmpleado">Codigo de empleado</label></th>
                    </tr>
                    <tr class='tr-input'>
